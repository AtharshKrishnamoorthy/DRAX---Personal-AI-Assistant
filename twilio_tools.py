...
class TwilioTools(Toolkit):
    def __init__(
        ...
        self.from_number = from_number or getenv("TWILIO_FROM_NUMBER")
    ...
    def send_sms(self, to: str, body: str) -> str:
        ...
        try:
            ...
            if not self.validate_phone_number(self.from_number):
                return "Error: 'from' number must be in E.164 format (e.g., +1234567890)"
